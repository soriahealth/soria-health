...
export const familyMembers: FamilyMember[] = [
  {
    ...
    conditions: [
      ...
      { id: "c2", name: "Anxiety", diagnosedAge: 35 },
    ],
    recordsShared: 12,
    avatarColor: "#A8C5F5",
  },
...
export const deceasedFamilyMembers: FamilyMember[] = [
  {
    ...
    bloodType: "A+",
    conditions: [
      { id: "dc1", name: "Breast Cancer", diagnosedAge: 58 },
      { id: "dc2", name: "Type 2 Diabetes", diagnosedAge: 62 },
      { id: "dc3", name: "Osteoporosis", diagnosedAge: 70 },
    ],
    recordsShared: 0,
    avatarColor: "#9CA3AF",
    isDeceased: true,
  ...
  },
  {
    ...
    bloodType: "O+",
    conditions: [
      { id: "dc4", name: "Heart Disease", diagnosedAge: 55 },
      { id: "dc5", name: "High Blood Pressure", diagnosedAge: 48 },
      { id: "dc6", name: "High Cholesterol", diagnosedAge: 50 },
    ],
    recordsShared: 0,
    avatarColor: "#9CA3AF",
    isDeceased: true,
  ...
  },
  {
    ...
    bloodType: "B+",
    conditions: [
      { id: "dc7", name: "Alzheimer's Disease", diagnosedAge: 72 },
      { id: "dc8", name: "Glaucoma", diagnosedAge: 65 },
    ],
    recordsShared: 0,
    avatarColor: "#9CA3AF",
    isDeceased: true,
  ...
  },
  {
    ...
    bloodType: "O+",
    conditions: [
      { id: "dc9", name: "Colon Cancer", diagnosedAge: 61 },
      { id: "dc10", name: "Type 2 Diabetes", diagnosedAge: 58 },
    ],
    recordsShared: 0,
    avatarColor: "#9CA3AF",
    isDeceased: true,
